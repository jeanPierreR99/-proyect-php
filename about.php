...
<body>
    ...
    <section id="about-head" class="section-p1">
        ...
        <div>
            <h2>¿Quiénes Somos?</h2>
            <p>
            Hola soy Dayana, soy quien empezò con este emprendimiento como 
una salida para dejar de sobrepensar y al mismo tiempo generar
ingresos. 
Soy una persona de caracter, optimista y persistente.
Esas serìan tres palabras para definirme.

DayanA Crochet es una tienda de tejidos Artesanales
que nace en la Pandemia del Covid-19. 
Actualmente una sola persona se encarga de todas las areas dentro
de la empresa.
Me apasiona el tejido con la técnica crochet y quiero
que este hermoso arte no se pierda y se empiece a valorizar
màs. 
Así empezó DayanA Crochet, y seguiremos creciendo.
Gracias. 
